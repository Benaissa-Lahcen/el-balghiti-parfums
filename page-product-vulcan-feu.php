        ...
        <div class="fragrance-pyramid mb-10 border-t border-[var(--t-border-subtle)] pt-6">
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Sun-Ripe Mango</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Zesty Lemon</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Pink Pepper</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Ginger</span>
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Coumarin (Tonka)</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Jasmine</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Dry Wood Accord</span>
            </div>
          </div>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Golden Amber</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Cypriol (Nagarmotha)</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• White Musk</span>
              <span class="font-cormorant text-lg text-[var(--t-text-soft)]">• Cedar & Oud</span>
            </div>
          </div>
        </div>
