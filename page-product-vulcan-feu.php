  ...
  <main class="flex-grow pt-36 sm:pt-48 pb-24 px-6 md:px-16 w-full max-w-[1400px] mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-16 lg:gap-24 items-start max-w-screen-2xl mx-auto">
      ...
      <div class="flex flex-col gap-6 mb-12 md:mb-0">
        ...
        <!-- Thumbnail Gallery (User Photos Only) -->
        <div class="flex gap-3 sm:gap-4">
          <!-- Thumbnail 1: White Studio Shot -->
          <button class="w-16 h-16 sm:w-20 sm:h-20 border-2 border-[var(--t-text)] bg-[var(--t-bg-secondary)] p-1.5 flex items-center justify-center overflow-hidden cursor-pointer thumbnail-btn rounded-sm" onclick="changeProductImage('<?php echo get_template_directory_uri(); ?>/assets/images/vulcain-fire.jpg', this)">
          ...
          <!-- Thumbnail 2: Dark Geode Cinematic Shot -->
          <button class="w-16 h-16 sm:w-20 sm:h-20 border border-[var(--t-border-subtle)] bg-[var(--t-bg-secondary)] p-1.5 flex items-center justify-center overflow-hidden cursor-pointer thumbnail-btn rounded-sm" onclick="changeProductImage('<?php echo get_template_directory_uri(); ?>/assets/images/vulcain-feu-photo2.jpg', this)">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vulcain-feu-photo2.jpg" alt="Vulcan Feu dark geode shot" class="max-h-full max-w-full object-cover">
          </button>
          <!-- Thumbnail 3: Infographic Bottle & Notes Shot -->
          <button class="w-16 h-16 sm:w-20 sm:h-20 border border-[var(--t-border-subtle)] bg-[var(--t-bg-secondary)] p-1.5 flex items-center justify-center overflow-hidden cursor-pointer thumbnail-btn rounded-sm" onclick="changeProductImage('<?php echo get_template_directory_uri(); ?>/assets/images/vulcain-feu-photo3.jpg', this)">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vulcain-feu-photo3.jpg" alt="Vulcan Feu notes infographic" class="max-h-full max-w-full object-cover">
          </button>
        </div>
      ...
      <div class="product-info-container flex flex-col">
        ...
        <div class="fragrance-pyramid mb-10 border-t border-[var(--t-border-subtle)] pt-6">
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-mango.jpg" alt="Mango" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">Mango</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-lemon.jpg" alt="Lemon" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">Zesty Lemon</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-pinkpepper.jpg" alt="Pink Pepper" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">Pink Pepper</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-ginger.jpg" alt="Ginger" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-jasmine.jpg" alt="Jasmine" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">Jasmine</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-drywood.jpg" alt="Dry Wood" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-amber.png" alt="Amber" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">Golden Amber</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-musk.png" alt="Musk" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
                <span class="font-cormorant text-base text-[var(--t-text-soft)]">White Musk</span>
              </div>
              <div class="flex items-center gap-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/note-oud.png" alt="Oud" style="width:32px; height:32px; min-width:32px; min-height:32px; max-width:32px; max-height:32px; border-radius:50%; object-fit:cover; display:inline-block;" class="border border-[var(--t-border-subtle)] shadow-sm">
