      ...
      <div style="display:flex; flex-wrap:wrap; gap:2.5rem; width:100%;">
        ...
        <div id="popular-searches-col" style="flex:0 0 240px; border-right:1px solid rgba(0,0,0,0.1); padding-right:1.5rem;">
          ...
          <ul style="display:flex; flex-direction:column; gap:0.75rem; list-style:none; padding:0; margin:0;" class="font-montserrat uppercase tracking-wider text-xs sm:text-sm">
            ...
            <li><button type="button" onclick="setSearchQuery('Vulcan Feu')" class="text-left text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors py-1 cursor-pointer">Vulcan Feu</button></li>
  ...
  <script>
    if (typeof window.perfumeCatalog === 'undefined') {
      window.perfumeCatalog = [
        ...
        { name: "Vulcan Feu", brand: "French Avenue", inspiredBy: ["God of Fire", "SHL", "Stephane Humbert Lucas"], type: "Branded Dupe", notes: "Mango, Lemon, Amber", price: "370 DH", image: "assets/images/vulcain-fire.jpg", url: "product-vulcan-feu.html" },
