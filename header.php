      ...
      <div class="max-w-7xl mx-auto px-4 md:px-12 py-3.5 sm:py-5 flex flex-col md:gap-4 justify-between w-full">
        ...
        <div class="flex items-center justify-between w-full relative">
          ...
          <div class="flex items-center gap-3">
            ...
            <button class="md:hidden text-[var(--t-text)] cursor-pointer" aria-label="Search">
            ...
            <!-- Desktop Search Box -->
            <div class="hidden md:flex items-center gap-2 text-xs tracking-wider text-[var(--t-text-muted)] cursor-pointer hover:text-[var(--t-text)] transition-colors">
